                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content" id="dropdown-content">
                                    ...
                                    <div class="grid-container">
                                        ...
                                        <div class="courses">
                                            <div class="ceh" onmouseover="mouseOverceh()" onmouseout="mouseOutceh()"><i class='fas fa-long-arrow-alt-right' style='font-size:25px'></i><a>Certified Ethical Hacker</a></div>
                                            <div class="cpe" onmouseover="mouseOvercpe()" onmouseout="mouseOutcpe()"><i class='fas fa-long-arrow-alt-right' style='font-size:25px'></i><a>cpe</a></div>
                                        </div>
                                    </div>
